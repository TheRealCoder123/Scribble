...
fun GreenAuthButton(
    ...
    Button(
        ...
        Text(text = text, color = if (isEnabled) Color.Black else Color.Gray)
        Spacer(modifier = Modifier.width(10.dp))
        Icon(
            imageVector = Icons.Default.ArrowForward,
            contentDescription = stringResource(R.string.cont),
        )
    }
...
@Preview
@Composable
fun GreenAuthButtonPreview() {
    GreenAuthButton(text = "Continue", isEnabled = true){
